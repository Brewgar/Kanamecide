...
# H-0002-hand-tuned STUB — SUPERSEDED (content moved to H-0004 on 2026-09-09)

Content moved to H-0004-hand-tuned-evaluation-baseline-sufficient-for-2500-elo.md.
Retained for filename history only. Body archived below for provenance; do not cite.

---

# ARCHIVED BODY (moved to H-0004; status SUPERSEDED)
...
## Status
SUPERSEDED (moved to H-0004; see stub header).
